        ...
        for 腔, 方言音 in 詞條.items():
            if 方言音.strip() not in ['x', '暫無資料']:
                for 音 in 方言音.strip().split(','):
                    ...
                    for 音標 in 音標組.split(';'):
                        for 字, 音 in self.處理全部的漢字音標(漢字, 音標.strip()):
                            yield {
                                '文本資料': 字,
                                '種類': 字詞,
                                '屬性': {'音標': 音, '腔口': 腔 + '腔'},
...
#                 }
    ...
    def 漢字音標特別格式處理(self, 漢字, 音標):
        ...
        if 漢字 in 有解釋字:
            ...
            return 漢字, self.實際音懸轉臺羅音標(音標)
        elif (漢字, 音標) in self.日語替換:
            return self.日語替換[(漢字, 音標)], self.實際音懸轉臺羅音標(音標)
        elif (漢字, 音標) in 錯誤音標:
...
#                             資料型體 = "䆀猴𠢕欠數。"
    ...
    日語替換 = {
        ('アルミ', 'a33-lu55-mih3'): 'アルミ',
        ('まんが', 'bang51-ga11'): '⿰まんが',
        ('ビル', 'bi51-lu11'): 'ビル',
        ('ビ—ル', 'bi51-lu11'): '⿰ビ—ル',
        ('みそ', 'bi55-sooh3'): 'みそ',
        ('ブラジゃ—', 'bu33-la51-jia11'): 'ブラ⿰⿰ジャ—',
        ('ブラジャ—', 'bu33-la55-tsia11'): 'ブラ⿰⿰ジャ—',
        ('じどうしゃ', 'gi33-loo51-sia11'): 'じ⿰どう⿰しゃ',
        ('はしか', 'ha33-si55-khah3'): 'はしか',
        ('ホテル', 'hoo33-te55-luh3'): 'ホテル',
        ('じどうしゃ', 'ji33-lo51-sia11'): 'じ⿰どう⿰しゃ',
        ('じどうしゃ', 'ji33-loo51-sia11'): 'じ⿰どう⿰しゃ',
        ('じしゃく', 'ji33-sia55-kuh3'): 'じ⿰しゃく',
        ('にんじん', 'jin33-jin13'): '⿰にん⿰じん',
        ('にんじん', 'jin35-jin51'): '⿰にん⿰じん',
        ('コレラ', 'khoo33-le55-lah3'): 'コレラ',
        ('レコード', 'le33-khoo51-too11'): 'レ⿰コード',
        ('じどうしゃ', 'li33-lo51-sia11'): 'じ⿰どう⿰しゃ',
        ('にんじん', 'lin35-jin51'): '⿰にん⿰じん',
        ('にんじん', 'lin35-tsin51'): '⿰にん⿰じん',
        ('りんご', 'lin51-goo11'): '⿰りんご',
        ('ロ—ス', 'loo51-sir11'): '⿰ロ—ス',
        ('ロ—ス', 'loo51-su11'): '⿰ロ—ス',
        ('メンス', 'me51-su11'): '⿰メンス',
        ('ミシン', 'mi33-sin51'): 'ミ⿰シン',
        ('みそしる', 'mi33-so55-si55-luh3'): 'みそしる',
        ('みそ', 'mi55-soh3'): 'みそ',
        ('みそ', 'mi55-sooh3'): 'みそ',
        ('ネクタイ', 'ne33-kut5-tai51'): 'ネク⿰タイ',
        ('おニンギョウ', 'o33-lin55-gio5'): 'お⿰ニン⿰⿰ギョウ',
        ('おニンギョウ', 'o33-lin55-gio51'): 'お⿰ニン⿰⿰ギョウ',
        ('オニンギョウ', 'o33-lin55-gioh5'): 'オ⿰ニン⿰⿰ギョウ',
        ('パチンコ', 'pha33-tshin51-ko11'): 'パ⿰チンコ',
        ('パン', 'pháng'): '⿰パン',
        ('スリッパ', 'sir33-li55-pah3'): 'ス⿰リッパ',
        ('スリッパ', 'sir33-lit5-pah3'): 'ス⿰リッパ',
        ('ステンレス', 'sir33-tian55-le51-sir11'): 'ス⿰テンレス',
        ('スリッパ', 'su33-li55-pah3'): 'ス⿰リッパ',
        ('トマト', 'thoo33-ma55-tooh3'): 'トマト',
        ('とうさん', 'too51-sang11'): '⿰とう⿰さん',
        ('わさび', 'ua33-sa55-bih3'): 'わさび',
        ('ぞうり仔', 'lo55-li55-a51'): '⿰ぞうり仔',
        ('ガラ油', 'gat5-la55-iû'): 'ガラ油',
        ('鳶', 'thong51-bi11'): '⿰とんび',
        ('ガス', 'ga55-suh3'): 'ガス',
        ('ガス', 'ga55 suh3'): 'ガス',
        ('バス', 'ba55-sirh3'): 'バス',
        ('ロ—ス肉', 'loo55-su55-bah'): '⿰ロ—ス肉',
        ('ロ—ス肉', 'loo51-su51 bah'): '⿰ロ—ス肉',
        ('おかあさん', 'oo33-kha51-sang11'): 'お⿰かあ⿰さん',
        ('オニンギョウ', 'o33-lin55-gio51'): 'オ⿰ニン⿰⿰ギョウ',
        ('かあさん', 'kha51-sang11'): '⿰かあ⿰さん',
        ('れんたん', 'lian35-tang51'): '⿰れん⿰たん',
        ('ガソリン', 'ga33-soo55-lin51'): 'ガソ⿰リン',
        ('へルメット', 'he33-nu55-miat5-tooh3'): 'へル⿰メット',
        ('チャック', 'jia55-kuh3'): '⿰⿰チャック',
        ('チャック', 'jiak5-khuh3'): '⿰⿰チャック',
        ('チャック', 'jia55-khuh3'): '⿰⿰チャック',
        ('チャック', 'jiak5-kuh3'): '⿰⿰チャック',
        ('チャック', 'tsiak5-kuh3'): '⿰⿰チャック',
        ('チャック', 'jiak5-kuh3'): '⿰⿰チャック',
        ('チャック', 'tsiak5-kuh3'): '⿰⿰チャック',
        ('じゃんけん', 'jiang55-kian55-pho51-sirh3'): '⿰⿰じゃん⿰けんぼ-sirh3',
        ('風呂', 'hu55-looh3'): '風呂',
        ('風呂', 'hu55-loh3'): '風呂',
        ('風呂桶', 'hu55-lo55-tháng'): '風呂桶',
        ('風呂桶', 'hu55-loo55-tháng'): '風呂桶',
        ('瀧', 'tha55-khih3'): 'たき',
        ('簞笥', 'thang51-su11'): '簞笥',
        ('簞笥', 'thang51-sirh3'): '簞笥',
        ('簞笥', 'thang51-suh3'): '簞笥',
